#ifndef SRC_COMPILER_INCLUDE_HADRON_LSB_HASH_TABLE_HPP_
#define SRC_COMPILER_INCLUDE_HADRON_LSB_HASH_TABLE_HPP_
...
#endif // SRC_COMPILER_INCLUDE_HADRON_LSB_HASH_TABLE_HPP_