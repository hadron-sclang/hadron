...
namespace hadron {
...
#if defined(__i386__)
    static constexpr size_t kNumberOfPhysicalRegisters = 8 - 2;
    static constexpr size_t kNumberOfPhysicalFloatRegisters = 8;
    using Word = int32_t;
    using UWord = uint32_t;
#elif defined(__x86_64__)
    static constexpr size_t kNumberOfPhysicalRegisters = 16 - 2;
    ...
    static constexpr size_t kNumberOfPhysicalRegisters = 32 - 2;
    static constexpr size_t kNumberOfPhysicalFloatRegisters = 32;
    using Word = int64_t;
    using UWord = uint64_t;
#else
