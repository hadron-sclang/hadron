...
mod tests {
    ...
    fn smoke_test() {
        check_lexing(
            ...
            vec![
                ...
                Token {
                    kind: Delimiter { kind: ParenClose },
                    string: ")",
                    line: 1,
                    column: 49,
                },
                Token {
                    kind: Delimiter { kind: Semicolon },
                    string: ";",
                    line: 1,
                    column: 50,
                },
                ...
                Token {
                    kind: Delimiter { kind: BraceClose },
                    string: "}",
                    line: 1,
                    column: 57,
                },
    ...
    fn characters() {
        check_lexing(
            ...
            vec![
                Token {
                    kind: Character { is_escaped: true },
                    string: "$\\t",
                    line: 1,
                    column: 1,
                },
                Token {
                    kind: Character { is_escaped: false },
                    string: "$a",
                    line: 1,
                    column: 4,
                },
    ...
    fn delimiters() {
        check_lexing(
            ...
            vec![
                Token {
                    kind: Delimiter { kind: Caret },
                    string: "^",
                    line: 1,
                    column: 1,
                },
                Token {
                    kind: Delimiter { kind: Colon },
                    string: ":",
                    line: 1,
                    column: 2,
                },
                ...
                Token {
                    kind: Delimiter { kind: BracketOpen },
                    string: "[",
                    line: 1,
                    column: 8,
                },
                Token {
                    kind: Delimiter { kind: BracketClose },
                    string: "]",
                    line: 1,
                    column: 9,
                },
                Token {
                    kind: Delimiter { kind: Grave },
                    string: "`",
                    line: 1,
                    column: 10,
                },
                Token {
                    kind: Delimiter { kind: Hash },
                    string: r"#",
                    line: 1,
                    column: 11,
                },
                Token {
                    kind: Delimiter { kind: Tilde },
                    string: "~",
                    line: 1,
                    column: 12,
                },
                Token {
                    kind: Delimiter { kind: Underscore },
                    string: "_",
                    line: 1,
                    column: 13,
                },
