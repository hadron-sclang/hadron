#ifndef SRC_COMPILER_INCLUDE_HADRON_JIT_MEMORY_ARENA_HPP_
#define SRC_COMPILER_INCLUDE_HADRON_JIT_MEMORY_ARENA_HPP_
...
#endif // SRC_COMPILER_INCLUDE_HADRON_JIT_MEMORY_ARENA_HPP_